...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nexports.arrayToGrid = exports.createBuffer = void 0;\r\nvar Grid_1 = __importDefault(__webpack_require__(/*! ./modules/Grid */ \"../2djs/dist/src/core/modules/Grid.js\"));\r\nfunction createBuffer(width, height) {\r\n    var buffer = document.createElement('canvas');\r\n    buffer.width = width;\r\n    buffer.height = height;\r\n    return buffer;\r\n}\r\nexports.createBuffer = createBuffer;\r\nfunction arrayToGrid(array, rows, columns) {\r\n    var grid = new Grid_1.default();\r\n    for (var row = 0; row < rows; row++) {\r\n        for (var column = 0; column < columns; column++) {\r\n            var index = ((row * columns) + column);\r\n            grid.set(row, column, array[index]);\r\n        }\r\n    }\r\n    return grid;\r\n}\r\nexports.arrayToGrid = arrayToGrid;\r\n\n\n//# sourceURL=webpack:///../2djs/dist/src/core/helpers.js?");
...
/***/ "../2djs/dist/src/core/modules/Grid.js":
/*!*********************************************!*\
  !*** ../2djs/dist/src/core/modules/Grid.js ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar helpers_1 = __webpack_require__(/*! ../helpers */ \"../2djs/dist/src/core/helpers.js\");\r\nvar Tile = /** @class */ (function () {\r\n    function Tile(image, _a) {\r\n        var _b = _a === void 0 ? {} : _a, _c = _b.x, x = _c === void 0 ? 0 : _c, _d = _b.y, y = _d === void 0 ? 0 : _d, width = _b.width, height = _b.height;\r\n        var _e;\r\n        this.image = image;\r\n        this.x = x;\r\n        this.y = y;\r\n        this.width = !width ? this.image.width : width;\r\n        this.height = !height ? this.image.height : height;\r\n        var buffer = helpers_1.createBuffer(this.width, this.height);\r\n        (_e = buffer\r\n            .getContext('2d')) === null || _e === void 0 ? void 0 : _e.drawImage(this.image, this.x, this.y, this.width, this.height, 0, 0, this.width, this.height);\r\n        this.buffer = buffer;\r\n    }\r\n    return Tile;\r\n}());\r\nexports.default = Tile;\r\n\n\n//# sourceURL=webpack:///../2djs/dist/src/core/modules/Tile.js?");

/***/ }),

/***/ "../2djs/dist/src/core/modules/Tilemap.js":
/*!************************************************!*\
  !*** ../2djs/dist/src/core/modules/Tilemap.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar Grid_1 = __importDefault(__webpack_require__(/*! ./Grid */ \"../2djs/dist/src/core/modules/Grid.js\"));\r\nvar Tilemap = /** @class */ (function () {\r\n    function Tilemap(tileset, map, rows, columns) {\r\n        if (rows === void 0) { rows = 0; }\r\n        if (columns === void 0) { columns = 0; }\r\n        this.tileset = tileset;\r\n        this.rows = rows;\r\n        this.columns = columns;\r\n        var grid = new Grid_1.default();\r\n        for (var row = 0; row < rows; row++) {\r\n            for (var column = 0; column < columns; column++) {\r\n                var index = ((row * columns) + column);\r\n                grid.set(row, column, tileset.getTile(map[index]));\r\n            }\r\n        }\r\n        this.map = grid;\r\n    }\r\n    Tilemap.prototype.draw = function (g) {\r\n        var _this = this;\r\n        this.map.forEach(function (tile, row, column) {\r\n            g.drawTile(tile, column * _this.tileset.tileWidth, row * _this.tileset.tileHeight);\r\n        });\r\n    };\r\n    return Tilemap;\r\n}());\r\nexports.default = Tilemap;\r\n\n\n//# sourceURL=webpack:///../2djs/dist/src/core/modules/Tilemap.js?");

/***/ }),

/***/ "../2djs/dist/src/core/modules/Tileset.js":
/*!************************************************!*\
  !*** ../2djs/dist/src/core/modules/Tileset.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar Tile_1 = __importDefault(__webpack_require__(/*! ./Tile */ \"../2djs/dist/src/core/modules/Tile.js\"));\r\nvar Tileset = /** @class */ (function () {\r\n    function Tileset(image, tileWidth, tileHeight, rows, columns) {\r\n        if (tileWidth === void 0) { tileWidth = 16; }\r\n        if (tileHeight === void 0) { tileHeight = 16; }\r\n        this.image = image;\r\n        this.tileWidth = tileWidth;\r\n        this.tileHeight = tileHeight;\r\n        this.rows = rows;\r\n        this.columns = columns;\r\n        this.tiles = [];\r\n        for (var row = 0; row < this.rows; row++) {\r\n            for (var column = 0; column < this.columns; column++) {\r\n                var x = column * this.tileWidth;\r\n                var y = row * this.tileHeight;\r\n                this.tiles.push(new Tile_1.default(this.image, {\r\n                    x: x,\r\n                    y: y,\r\n                    width: this.tileWidth,\r\n                    height: this.tileHeight\r\n                }));\r\n            }\r\n        }\r\n    }\r\n    Object.defineProperty(Tileset.prototype, \"total\", {\r\n        /**\r\n         * Get total quantity of tiles\r\n         */\r\n        get: function () {\r\n            return this.rows * this.columns;\r\n        },\r\n        enumerable: false,\r\n        configurable: true\r\n    });\r\n    /**\r\n     * Get specific tile on Tileset\r\n     * @param index\r\n     */\r\n    Tileset.prototype.getTile = function (index) {\r\n        return this.tiles[index];\r\n    };\r\n    return Tileset;\r\n}());\r\nexports.default = Tileset;\r\n\n\n//# sourceURL=webpack:///../2djs/dist/src/core/modules/Tileset.js?");
...
/***/ "../2djs/dist/src/core/modules/input/controllers/MouseController.js":
/*!**************************************************************************!*\
  !*** ../2djs/dist/src/core/modules/input/controllers/MouseController.js ***!
  \**************************************************************************/
/*! no static exports found */
